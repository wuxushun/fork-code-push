...
module.exports = (NativeCodePush) => {
  ...
  // 0 nodiff  1 gdiff  2 hdiff
  const getDiffVersion = () => {
    if (typeof NativeCodePush.getDiffVersion !== 'function') {
        return 0;
    }
    return NativeCodePush.getDiffVersion();
  };

  return { local, remote, getDiffVersion };
};